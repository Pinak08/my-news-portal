...
// Renders YouTube, Instagram, Facebook, and WhatsApp icons that link straight
// to the channel/page. Used in both the header top bar and the footer so
// visitors can immediately recognize and reach the official channels.
export default function SocialIcons({ className = "", iconClassName = "w-5 h-5" }: Props) {
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      >
        <svg viewBox="0 0 24 24" fill="currentColor" className={iconClassName}>
          <path d="M22 12.06C22 6.5 17.52 2 12 2S2 6.5 2 12.06c0 5 3.66 9.16 8.44 9.94v-7.03H7.9v-2.9h2.54V9.85c0-2.5 1.5-3.89 3.78-3.89 1.1 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56v1.88h2.78l-.45 2.9h-2.33V22c4.78-.78 8.44-4.94 8.44-9.94Z" />
        </svg>
      </a>
      <a
